...
module "sg-dev" {
  source       = "/home/ec2-user/environment/ACS730-Group12-Project/modules/sg_group"
  prefix       = module.globalvars.prefix
...
module "alb-dev" {
  source       = "/home/ec2-user/environment/ACS730-Group12-Project/modules/load_balancer"
  prefix       = module.globalvars.prefix
  default_tags = module.globalvars.default_tags
  env          = var.env
...
module "launch-config-dev" {
  source        = "/home/ec2-user/environment/ACS730-Group12-Project/modules/launch_config"
  prefix        = module.globalvars.prefix
  env           = var.env
  sg_id         = module.sg-dev.lb_sg_id
  instance_type = var.instance_type
...
# Auto Scaling Group
module "asg-dev" {
  source             = "/home/ec2-user/environment/ACS730-Group12-Project/modules/autoscalling_group"
  prefix             = module.globalvars.prefix
  env                = var.env
  default_tags       = module.globalvars.default_tags
